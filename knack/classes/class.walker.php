...
class knack_walker extends Walker{

	#CONSTRUCT
	function __construct(){ }

	#HAS CHILDREN
	public $has_children, $count;
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if($this->has_children){
            $item_output .= '<div class="mobile-toggle" data-mobile="open"></div>';
        }
        $item_output .= '<a'. $attributes .' class="nav-link"><span>';
